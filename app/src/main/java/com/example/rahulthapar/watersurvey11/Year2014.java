...
public class Year2014 extends Activity {

   private EditText jan,feb,march,april,may,june,july,aug,sept,oct,nov,dec;
    private Button year2014;
    private String URL_YEAR_2014 = "http://192.168.0.106/Water_Supply_Survey/year2014.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jan = (EditText)findViewById(R.id.edit_jan_2014);
        feb = (EditText)findViewById(R.id.edit_feb_2014);
        march = (EditText)findViewById(R.id.edit_march_2014);
        april = (EditText)findViewById(R.id.edit_april_2014);
        may = (EditText)findViewById(R.id.edit_may_2014);
        june = (EditText)findViewById(R.id.edit_june_2014);
        july = (EditText)findViewById(R.id.edit_july_2014);
        aug = (EditText)findViewById(R.id.edit_august_2014);
        sept = (EditText)findViewById(R.id.edit_sept_2014);
        oct = (EditText)findViewById(R.id.edit_oct_2014);
        nov = (EditText)findViewById(R.id.edit_nov_2014);
        dec = (EditText)findViewById(R.id.edit_dec_2014);

        year2014= (Button)findViewById(R.id.save_next_year2014);
        year2014.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                new WaterUse2014().execute(jan_1,feb_1,march_1,april_1,may_1,june_1,july_1,aug_1,sept_1,oct_1,nov_1,dec_1);
                Intent i = new Intent(Year2014.this,Year2015.class);
                startActivity(i);
            }
        });
    ...
    private class WaterUse2014 extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... arg) {
            ...
            String json = serviceClient.makeServiceCall(URL_YEAR_2014,
